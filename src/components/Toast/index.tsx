...
export default function Toast({
    ...
    return (
        <View {...props} style={[estilos[estilo].card, props.style]}>
            <View style={estilos[estilo].infos}>
                <Feather name={icone} style={estilos[estilo].icone} />
                <Text style={estilos[estilo].texto}>{texto}</Text>
                {dispensavel ?
                    <TouchableOpacity>
                        <Feather name="x" style={estilos[estilo].fechar} />
                    </TouchableOpacity>
                    :
                    null
                }
            ...
            {possuiBotao ?
                <TouchableOpacity style={estilos[estilo].botao} onPress={aoPressionarBotao}>
                    <Text style={estilos[estilo].botaoTexto}>Confirmar</Text>
                </TouchableOpacity>
                :
                null
            }
